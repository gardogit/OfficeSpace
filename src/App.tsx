...
function AppContent() {
  ...
  const {
    ...
    error: dataError,
    retry: retryDataLoad,
  } = useMockDataLoader(mockData, 800);
  ...
  if (dataError || !data) {
    return (
      <div className="min-h-screen bg-gray-50 dark:bg-gray-900 flex items-center justify-center">
        <div className="max-w-md w-full bg-white dark:bg-gray-800 rounded-lg border border-red-200 dark:border-red-800 shadow-sm p-6">
          <div className="text-center">
            ...
            <p className="text-sm text-red-700 dark:text-red-200 mb-6">
              {dataError?.message ||
  ...
  const renderSectionContent = () => {
    switch (activeSection) {
        ...
        return (
          ...
          >
            ...
            <EnhancedErrorBoundary
              ...
              onError={(error) =>
                ErrorMetrics.getInstance().recordError(
                  "UpcomingEventsList",
                  error
                )
              }
          ...
          >
            ...
            <div className="bg-white dark:bg-gray-800 rounded-lg border border-gray-200 dark:border-gray-700 shadow-sm p-6">
              <p className="text-gray-600 dark:text-gray-300 mb-4">
                Encuentra enlaces rápidos y recursos útiles en la barra lateral
                derecha.
              </p>
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                <div className="p-4 bg-blue-50 dark:bg-blue-900/20 rounded-lg">
                  ...
                  <p className="text-sm text-blue-700 dark:text-blue-300">
                    Accesos directos a herramientas y recursos frecuentemente
                    utilizados.
                  </p>
                </div>
                <div className="p-4 bg-green-50 dark:bg-green-900/20 rounded-lg">
                  ...
                  <p className="text-sm text-green-700 dark:text-green-300">
                    Lanzador de aplicaciones corporativas y herramientas
                    externas.
                  </p>
                </div>
              </div>
      ...
      case "espacios":
        return (
          <section
            id="tabpanel-espacios"
            role="tabpanel"
            aria-labelledby="tab-espacios"
          >
            <h2
              id="spaces-heading"
              className="text-2xl font-semibold text-gray-900 dark:text-gray-100 mb-6"
            ...
            <div className="bg-white dark:bg-gray-800 rounded-lg border border-gray-200 dark:border-gray-700 shadow-sm p-6">
              <p className="text-gray-600 dark:text-gray-300 mb-4">
                Explora los espacios de colaboración disponibles en la barra
                lateral derecha.
              </p>
          ...
          >
            <div className="flex items-center">
              ...
              <div>
                ...
                <p className="text-sm mt-1">{dataHealth.issues.join(", ")}</p>
              </div>
            </div>
          </div>
        )}
              ...
              >
                <div className="flex flex-col items-center gap-4">
                  ...
                  <div className="text-gray-500 dark:text-gray-400">
                    ...
                    <p className="text-sm">
                      Intenta con otros términos de búsqueda o explora el
