    ...
    <form onSubmit={handleSubmit} className="relative" role="search" aria-label="Búsqueda en el portal">
      <div className="relative">
        ...
        <input
          ...
          className="block w-full pl-10 pr-3 py-2 border border-gray-300 dark:border-gray-600 rounded-lg leading-5 bg-white dark:bg-gray-700 text-gray-900 dark:text-gray-100 placeholder-gray-500 dark:placeholder-gray-400 focus-ring sm:text-sm"
        ...
        {query && (
          <div className="absolute inset-y-0 right-0 pr-3 flex items-center">
            <button
              ...
              className="text-gray-400 dark:text-gray-500 hover:text-gray-600 dark:hover:text-gray-300 focus-ring rounded p-1"
