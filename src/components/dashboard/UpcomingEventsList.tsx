...
const EventItem: React.FC<EventItemProps> = ({ event, isExpanded, onToggleExpand }) => {
  return (
    <div className="border-b border-gray-100 last:border-b-0 pb-4 last:pb-0 mb-4 last:mb-0">
      <div 
        className="cursor-pointer hover:bg-gray-50 p-3 rounded-md transition-colors duration-200"
      ...
      {isExpanded && (
        <div 
          className="mt-3 pl-3 border-l-2 border-primary-200 bg-gray-50 p-3 rounded-md"
          role="region"
