...
describe('NewHiresGrid Integration Tests', () => {
  ...
  it('sorts employees by start date correctly with real data', () => {
    ...
    const employeeCards = screen.getAllByText(/Desarrollador Frontend|Diseñadora UX\/UI|Analista de Datos|Product Manager|DevOps Engineer|QA Engineer|Backend Developer/);
